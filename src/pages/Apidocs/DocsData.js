export const DOCS_CONTENT = {
  ...
  location: {
    "by-pincode": {
      ...
      details: {
        usage:
          "Call this API to auto-fetch location details when user enters pincode.",
        params: [{ name: "pincode", description: "6-digit postal code" }],
        response: `{ "status": "success", "data": { "pincode": "110001", "city": "New Delhi", "state": "Delhi" }}`,
      },
    },

    "by-city": {
      title: "Get Location by City",
      description: "Retrieve pincodes and district/state using city name.",
      code: `curl "https://api.example.com/location/by-city?city=Delhi"`,
      details: {
        usage: "Use this API to fetch pincodes or validate city entries.",
        params: [{ name: "city", description: "City name" }],
        response: `{ "status": "success", "data": { "city": "Delhi", "state": "Delhi", "pincodes": ["110001","110002"] }}`,
      },
    },

    states: {
      title: "Get All States",
      description: "Retrieve all states and union territories.",
      code: `curl "https://api.example.com/location/states"`,
      details: {
        usage: "Use this API to populate a state dropdown.",
        params: [],
        response: `{ "status": "success", "data": { "states": ["Delhi", "Tamil Nadu", "Maharashtra"] }}`,
      },
    },
  },
